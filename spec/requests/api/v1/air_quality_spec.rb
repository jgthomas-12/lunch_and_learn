...
RSpec.describe "API V1 Air Quality request", type: :request do
  describe "GET /api/v1/air_quality?country=France" do
    ...
    describe "happy path - nigeria" do
      it "returns air quality JSON object from a specified country", :vcr do

        get '/api/v1/air_quality', params: { country: 'nigeria' }, headers: { 'Accept' => 'application/json' }
    ...
    describe "happy path - cuba" do
      it "returns air quality JSON object from a specified country", :vcr do

        get '/api/v1/air_quality', params: { country: 'cuba' }, headers: { 'Accept' => 'application/json' }
